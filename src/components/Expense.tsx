  ...
  return (
    <div className="flex-1 p-8 overflow-y-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-text-main">Expense</h1>
          <p className="text-sm text-text-muted mt-1">Operational Costs</p>
        </div>
        <div>
      ...
      <div className="panel mb-8 flex flex-wrap gap-4 items-end">
        <div className="flex flex-col gap-1.5 flex-1 min-w-[220px]">
          ...
          <input
            ...
            placeholder="Search receiver, payer or purpose..."
            value={searchTerm}
            ...
            <tbody>
              {filteredTransactions.map((tx) => (
                <tr key={tx.id}>
                  ...
                  <td className="text-outflow text-right font-bold">
                  ...
                  <td className="text-center">
                    <button
                      ...
                      title="Delete"
                      onClick={() => {
                        if (confirm("Delete this expense record?")) deleteTransaction(tx.id);
                      }}
                    >✕</button>
                  </td>
                </tr>
              ...
              {filteredTransactions.length === 0 && (
                <tr>
                  <td colSpan={6}>
                    <div className="flex items-center justify-center p-8 text-sm text-text-muted">No Expense records found.</div>
                  </td>
                </tr>
              )}
            </tbody>
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-panel border border-border rounded-sm w-full max-w-lg shadow-xl overflow-hidden">
            <div className="flex items-center justify-between p-4 border-b border-border bg-slate-900/30">
              <span className="font-bold text-lg">Record Expense</span>
            ...
            <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="form-group">
                  <label className="form-label">Receiver (Vendor/Payee)</label>
