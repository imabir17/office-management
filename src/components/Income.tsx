  ...
  return (
    <div className="flex-1 p-8 overflow-y-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-text-main">Income</h1>
          <p className="text-sm text-text-muted mt-1">Generated Revenue</p>
        </div>
        <div>
          ...
          <table className="data-table">
            ...
            <tbody>
                ...
                <tr key={tx.id}>
                  ...
                  <td className="text-center">
                    <button
                      ...
                      title="Delete"
                      onClick={() => {
                        if (confirm("Delete this income record?")) deleteTransaction(tx.id);
                      }}
                    >✕</button>
                  </td>
                </tr>
              ...
              {filteredTransactions.length === 0 && (
                <tr>
                  <td colSpan={6}>
                    <div className="flex items-center justify-center p-8 text-sm text-text-muted">No Income records found.</div>
                  </td>
                </tr>
              )}
            </tbody>
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-panel border border-border rounded-sm w-full max-w-lg shadow-xl overflow-hidden">
            <div className="flex items-center justify-between p-4 border-b border-border bg-slate-900/30">
              <span className="font-bold text-lg">Record Income</span>
            ...
            <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="form-group">
                  <label className="form-label">Payer (Client/Customer)</label>
